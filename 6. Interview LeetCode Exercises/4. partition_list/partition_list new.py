...
class LinkedList:
    ...
    def partition_list(self,x):
        ...
        prev1 = dummy2.next
        """
        else: # ou seja, se o valor do dummy 1 for >= x,
            # e sendo o dummy1 a cabeça da lista que contem valores menores que x,
            # não faz sentido um valor >= x estar na lista do dummy1, porque ela é so para valores < x
            pass
        """
